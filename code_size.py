def count_lines_of_code(filename):
    ...
    # Initialize counts for NCLOC and CLOC
    ncloc_count = 0
    cloc_count = 0
    
    # Iterate through lines to count NCLOC and CLOC
    for line in lines:
        line = line.strip()
    ...
    return ncloc_count, cloc_count, analysis

def main():
    file_path = input("Enter the path of the Python file: ")
    
    # Calculate lines of code
    ncloc, cloc, analysis = count_lines_of_code(file_path)
